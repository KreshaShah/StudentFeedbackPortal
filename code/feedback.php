...
<h4>(5): Outstanding    (4):Very Good             (3): Good   (2): Satisfactory                  (1):Needs Improvement</h4>
 ...
 --> 
    ...
    <?php
      ...
      echo "<td><label>Faculty Name: $fname</label></td>";
       ...
       $fq_query="select * from fb_questions where qtype='F'";
